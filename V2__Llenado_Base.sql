...
-- Generador aleatorio de wastemov
CREATE PROCEDURE [dbo].[InsertWasteMovements]
    @numRecords INT 
AS 
BEGIN 
    SET NOCOUNT ON; 
...
END
go
EXEC InsertWasteMovements @numRecords = 200000;
go

INSERT INTO [dbo].[containerActions]([actionName])
VALUES
 ('Cleaning')
CREATE PROCEDURE GenerateContainerMovements
AS
BEGIN
...
exec GenerateContainerMovements